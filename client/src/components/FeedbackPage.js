...
function Input(props) {
  return <input className="feedback-input" {...props} />;
}
...
function Textarea(props) {
  return <textarea className="feedback-input" {...props} />;
}
...
export function FeedbackPage({ user, onNavigate }) {
  ...
  const StarRating = () => (
    <div className="star-rating-container">
      {[1, 2, 3, 4, 5].map((star) => {
        const isFilled = star <= feedbackForm.rating;
        return (
          <button
            key={star}
            type="button"
  ...
  return (
    <div className="min-h-screen bg-background py-8">
      <div className="feedback-container max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="mb-2">Share Your Feedback</h1>
          <p className="text-muted-foreground">
            We value your opinion! Let us know about your experience with OK
            Clinic.
          </p>
        </div>
        <Card>
